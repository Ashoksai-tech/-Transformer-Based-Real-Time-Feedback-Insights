...
data = load_data('C:/Users/aasho/OneDrive/Desktop/transformer pipeline/data/sentiment_analysis.csv')
...
if check_staleness(test_dataset):
    logging.warning("Model staleness detected. Triggering retraining alert.")
    send_email_alert()
else:
    logging.info("Model is not stale.")
